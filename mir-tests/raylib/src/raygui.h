...
//----------------------------------------------------------------------------------
    ...
    #define LIGHTGRAY  RAYGUI_CLITERAL(Color){ 200, 200, 200, 255 }   // Light Gray
    #define GRAY       RAYGUI_CLITERAL(Color){ 130, 130, 130, 255 }   // Gray
    #define DARKGRAY   RAYGUI_CLITERAL(Color){ 80, 80, 80, 255 }      // Dark Gray
    #define YELLOW     RAYGUI_CLITERAL(Color){ 253, 249, 0, 255 }     // Yellow
    #define GOLD       RAYGUI_CLITERAL(Color){ 255, 203, 0, 255 }     // Gold
    #define ORANGE     RAYGUI_CLITERAL(Color){ 255, 161, 0, 255 }     // Orange
    #define PINK       RAYGUI_CLITERAL(Color){ 255, 109, 194, 255 }   // Pink
    #define RED        RAYGUI_CLITERAL(Color){ 230, 41, 55, 255 }     // Red
    #define MAROON     RAYGUI_CLITERAL(Color){ 190, 33, 55, 255 }     // Maroon
    #define GREEN      RAYGUI_CLITERAL(Color){ 0, 228, 48, 255 }      // Green
    #define LIME       RAYGUI_CLITERAL(Color){ 0, 158, 47, 255 }      // Lime
    #define DARKGREEN  RAYGUI_CLITERAL(Color){ 0, 117, 44, 255 }      // Dark Green
    #define SKYBLUE    RAYGUI_CLITERAL(Color){ 102, 191, 255, 255 }   // Sky Blue
    #define BLUE       RAYGUI_CLITERAL(Color){ 0, 121, 241, 255 }     // Blue
    #define DARKBLUE   RAYGUI_CLITERAL(Color){ 0, 82, 172, 255 }      // Dark Blue
    #define PURPLE     RAYGUI_CLITERAL(Color){ 200, 122, 255, 255 }   // Purple
    #define VIOLET     RAYGUI_CLITERAL(Color){ 135, 60, 190, 255 }    // Violet
    #define DARKPURPLE RAYGUI_CLITERAL(Color){ 112, 31, 126, 255 }    // Dark Purple
    #define BEIGE      RAYGUI_CLITERAL(Color){ 211, 176, 131, 255 }   // Beige
    #define BROWN      RAYGUI_CLITERAL(Color){ 127, 106, 79, 255 }    // Brown
    #define DARKBROWN  RAYGUI_CLITERAL(Color){ 76, 63, 47, 255 }      // Dark Brown
    #define WHITE      RAYGUI_CLITERAL(Color){ 255, 255, 255, 255 }   // White
    #define BLACK      RAYGUI_CLITERAL(Color){ 0, 0, 0, 255 }         // Black
    #define BLANK      RAYGUI_CLITERAL(Color){ 0, 0, 0, 0 }           // Blank (Transparent)
    #define MAGENTA    RAYGUI_CLITERAL(Color){ 255, 0, 255, 255 }     // Magenta
    #define RAYWHITE   RAYGUI_CLITERAL(Color){ 245, 245, 245, 255 }   // My own White (raylib logo)
    ...
    typedef struct Font {
        ...
        GlyphInfo *glyphs;      // Characters info data
    } Font;
            ...
            if (textLength > 0)
            {
                if (IsKeyPressed(KEY_BACKSPACE))
                {
                    ...
                    else
                    {
                        ...
                        int charUTF8Length = 0;
                        while ((charUTF8Length < textLength) && ((unsigned char)text[textLength - 1 - charUTF8Length] & 0x40) == 0) charUTF8Length++; // 0b01000000 = 0x40
